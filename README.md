...
### cyber_vaccine - SQL Injection Scanner
Scanner for detecting and exploiting SQL injection vulnerabilities. Provide a URL and it will identify vulnerable parameters, fingerprint the database engine (MySQL or SQLite), and extract its contents: tables, columns, and data, saved to an output file.
...
- **Concepts**: TOTP/HOTP, AES encryption, filesystem monitoring, reverse engineering, .onion services, web scraping, ARP spoofing, MitM, SQL injection
